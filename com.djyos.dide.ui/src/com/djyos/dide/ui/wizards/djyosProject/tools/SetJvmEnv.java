...
public class SetJvmEnv {
	...
	public static <K, V> void setenv(final String key, final String value) {
		...
		// final Class<?> processEnvironmentClass =
		// Class.forName("java.lang.ProcessEnvironment");
		// final Field theEnvironmentField =
		...
		// final Class<K> variableClass = (Class<K>)
		// Class.forName("java.lang.ProcessEnvironment$Variable");
		// final Method convertToVariable = variableClass.getMethod("valueOf",
		// String.class);
		// final boolean conversionVariableAccessibility =
		// convertToVariable.isAccessible();
		// convertToVariable.setAccessible(true);
		//
		// // The ProcessEnvironment$Value is the value fo the map
		// final Class<V> valueClass = (Class<V>)
		...
		// env.put((K) convertToVariable.invoke(null, key), (V)
		// convertToValue.invoke(null, value));
		//
		...
		// final boolean insensitiveAccessibility =
		// theCaseInsensitiveEnvironmentField.isAccessible();
		// theCaseInsensitiveEnvironmentField.setAccessible(true);
		// // Not entirely sure if this needs to be casted to
		// ProcessEnvironment$Variable
		// // and $Value as well
		// final Map<String, String> cienv = (Map<String, String>)
		...
		// .filter(c1 ->
		// "java.util.Collections$UnmodifiableMap".equals(c1.getName())).map(c1 -> {
		// try {
		...
		// // entire map
		// System.out.printf("Attempted to modify source map: " +
		...
		// }
		// System.out.printf(
		// "Set environment variable <" + key + "> to <" + value + ">. Sanity Check: " +
		// System.getenv(key));
	}
