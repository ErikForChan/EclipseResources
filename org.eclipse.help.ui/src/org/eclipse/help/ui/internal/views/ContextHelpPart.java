...
public class ContextHelpPart extends SectionPart implements IHelpPart {
	...
	public void handleActivation(IContextProvider provider, IContext context,
		...
		if(pageTitle.equals("DJYOS Project")) {
			setDefaultText(djyosProjectDesc);
		}else if(pageTitle.equals("Memory Map")){
			setDefaultText(memoryMapDesc);
		}else if(pageTitle.equals("Module Configuration")){
			setDefaultText(moduleConfigDesc);
		}else {
	 ...
	 */
	String[] computeSearchTerms(Control c) {
