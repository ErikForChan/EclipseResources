/*
 * Description: Define the system configuration, memory & IO base
 * address, flash size & address, interrupt resource for smartcard soc.
 *
 * Copyright (C) : 2014 Hangzhou C-SKY Microsystems Co.,LTD.
 * Author(s): Liu Bing (bing_liu@c-sky.com)
 * Contributors: Liu Bing
 * Date:  2010-06-26
 * Modify by liu jirang(jirang_liu@c-sky.com)  on 2014-2-28
 */

#ifndef __INCLUDE_CKSMART_CARD_H
#define __INCLUDE_CKSMART_CARD_H
...
/*
 * Define number of the coretim interrupt
 */
#define  CK_TIMER_IRQ0				CK_INTC_CORETIM

#endif /* __INCLUDE_CKSMART_CARD_H */
