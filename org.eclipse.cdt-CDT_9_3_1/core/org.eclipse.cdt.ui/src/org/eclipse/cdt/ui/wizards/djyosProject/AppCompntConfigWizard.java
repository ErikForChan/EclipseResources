...
public class AppCompntConfigWizard extends WizardPage{
	...
	protected AppCompntConfigWizard(String pageName,OnBoardCpu cpu,Board board) {
		super(pageName);
...
//					}
	...
	public IWizardPage getNextPage() {
		...
		if(! nmWizard.addedIbootCfg) {
			if(nmWizard.haveIboot()){
				nmWizard.ibootCfgPage = new IbootCompntConfigWizard("basicModuleCfgPage",onBoardCpu,sBoard);
