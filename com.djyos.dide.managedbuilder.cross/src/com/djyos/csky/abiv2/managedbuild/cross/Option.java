package com.djyos.csky.abiv2.managedbuild.cross;
...
public class Option{
	...
	public static final String OPTION_ISENHANCEDLRW = OPTION_PREFIX + ".isEnhancedLRW";
	...
	private static String getCSkyCpuTypeFlags(IConfiguration config) {
		...
		sValue = getOptionBooleanCommand(config, OPTION_ISENHANCEDLRW);
		if (sValue != null && sValue.length() > 0)
			sReturn += " " + sValue;
