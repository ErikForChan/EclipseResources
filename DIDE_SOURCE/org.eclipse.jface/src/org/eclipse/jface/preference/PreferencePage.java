...
public abstract class PreferencePage extends DialogPage implements IPreferencePage {
	...
	/**
	 * Standard Defaults button, or <code>null</code> if none. This button has id
	 * <code>DEFAULTS_ID</code>.
	 */
	private Button defaultsButton = null;

	/**
	 * The container this preference page belongs to; <code>null</code> if none.
	 */
	private IPreferencePageContainer container = null;

	/**
	 * Standard Apply button, or <code>null</code> if none. This button has id
	 * <code>APPLY_ID</code>.
	 */
	 ...
	 * <p>
	 * The default implementation of this <code>IPreferencePage</code> method
	 * returns the size set by <code>setSize</code>; if no size has been set, but
	 * the page has a UI control, the framework method <code>doComputeSize</code> is
	 * called to compute the size.
	 * </p>
	 *
	 * @return the size of the preference page encoded as
	 *         <code>new Point(width,height)</code>, or <code>(0,0)</code> if the
	 *         page doesn't currently have any UI component
	 */
	@Override
	 ...
	 * <code>IDialogPage</code> method creates a description label and button bar
	 * for the page. It calls <code>createContents</code> to create the custom
	 ...
	 * <p>
	 * All pages should override this method and set the appropriate sizes of their
	 * widgets, and then call <code>super.doComputeSize</code>.
	 * </p>
	 *
	 * @return the size of the preference page encoded as
	 ...
	 *
	 * @return the preference page container, or <code>null</code> if this page has
	 ...
	 * returns whether this preference page is valid. Preference pages are
	 * considered valid by default; call <code>setValid(false)</code> to make a page
	 * invalid.
	 * 
	 ...
	 * <p>
	 * Subclasses wishing a preference page without these buttons should call this
	...
	/**
	 * The <code>PreferencePage</code> implementation of this
	 * <code>IPreferencePage</code> method returns <code>true</code> if the page is
	 * valid.
	 *
	 ...
	 * Apply button has been pressed. The default implementation of this framework
	 * method simply calls <code>performOk</code> to simulate the pressing of the
	 * page's OK button.
	 * </p>
	 *
	 * @see #performOk()
	 ...
	 * "http://msdn.microsoft.com/en-us/library/windows/desktop/aa511266.aspx#commitButtons">Windows</a>
	 * wants applied changes to persist on Cancel, whereas <a href=
	 * "http://developer.apple.com/library/mac/#documentation/UserExperience/Conceptual/AppleHIGuidelines/Windows/Windows.html#//apple_ref/doc/uid/20000961-TPXREF58">Mac</a>
	 * and <a href=
	 ...
	 * <p>
	 * If preferenceStore is set to null, getPreferenceStore will invoke
	 * doGetPreferenceStore the next time it is called.
	 * </p>
	 *
	 * @param store
	...
	/**
	 * The <code>PreferencePage</code> implementation of this
	 * <code>IDialogPage</code> method extends the <code>DialogPage</code>
	 * implementation to update the preference page container title. Subclasses may
	 * extend.
	 * 
	...
	/**
	 * Sets whether this page is valid. The enable state of the container buttons
	 * and the apply button is updated when a page's valid state changes.
	 * <p>
	 *
	 * @param b
	 *            the new valid state
	...
	/**
	 * Updates the enabled state of the Apply button to reflect whether this page is
	 * valid.
	 */
	 ...
	 * <p>
	 * It is up to the subclasses to specify the contract and the data format. The
	 * contract is not guaranteed if the subclass is in an internal package.
	 * </p>
	 * <p>
	 * <strong>Note:</strong> The implementation must silently ignore all unknown
	 * data.
	 * </p>
	 * <p>
