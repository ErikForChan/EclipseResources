 ...
 * <p>
 * The class <code>Wizard</code> provides an abstract implementation of this
 * interface. However, clients are also free to implement this interface if
 * <code>Wizard</code> does not suit their needs.
 * </p>
 * 
 * @see Wizard
 */
public interface IWizard {
	 ...
	 * <p>
	 * The wizard container calls this method to create the controls for the
	 * wizard's pages before the wizard is opened. This allows the wizard to size
	 * correctly; otherwise a resize may occur when moving to a new page.
	 * </p>
	 *
	 * @param pageContainer
	 *            the parent control
	 ...
	 *
	 * @return the wizard container, or <code>null</code> if this wizard has yet to
	 ...
	 * <p>
	 * The dialog store is used to record state between wizard invocations (for
	 * example, radio button selections, last directory, etc.).
	 * </p>
	 *
	 ...
	 * <p>
	 * The result of this method is typically used by the container to show or hide
	 * a button labeled "Help".
	 * </p>
	 * <p>
	 * <strong>Note:</strong> This wizard's container might be a {@link TrayDialog}
	 * which provides its own help support that is independent of this property.
	 * </p>
	 * <p>
	 * <strong>Note 2:</strong> In the default {@link WizardDialog} implementation,
	 * the "Help" button only works when
	 * {@link org.eclipse.jface.dialogs.IDialogPage#performHelp()} is implemented.
	 * </p>
	 *
	 ...
	 *
	 * Normally this method is only called on the container's current wizard.
	 * However if the current wizard is a nested wizard this method will also be
	 * called on all wizards in its parent chain. Such parents may use this
	 * notification to save state etc. However, the value the parents return from
