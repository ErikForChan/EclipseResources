...
public abstract class ActionFactory {
	 ...
	 * the active editor. This action maintains its enablement state.
	 */
	// public static final ActionFactory NEW_PROJECT = new
	// ActionFactory("newProject", //$NON-NLS-1$
	...
	// throw new IllegalArgumentException();
	// }
	// WorkbenchCommandAction action = new WorkbenchCommandAction(getCommandId(),
	// window);
