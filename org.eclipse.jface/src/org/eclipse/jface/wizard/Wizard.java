...
public abstract class Wizard implements IWizard, IShellProvider {
	...
	/**
	 * The default page image for pages without one of their one; <code>null</code>
	 * if none.
	 */
	private Image defaultImage = null;

	/**
	 * The default page image descriptor, used for creating a default page image if
	 * required; <code>null</code> if none.
	 */
	...
	/**
	 * The <code>Wizard</code> implementation of this <code>IWizard</code> method
	 * does nothing and returns <code>true</code>. Subclasses should reimplement
	 * this method if they need to perform any special cancel processing for their
	 * wizard.
	 */
	@Override
	 ...
	 * <p>
	 * This image descriptor will be used to generate an image for a page with no
	 * image of its own; the image will be computed once and cached.
	 * </p>
	 *
	 ...
	 * <p>
	 * The dialog settings is used to record state between wizard invocations (for
	 * example, radio button selection, last import directory, etc.)
	 * </p>
	 *
	 * @param settings
	 ...
	 *
	 * @param b
	 *            <code>true</code> to always show Next and Previous buttons, and
	 *            <code>false</code> to suppress Next and Previous buttons for
	 *            single page wizards
	 */
