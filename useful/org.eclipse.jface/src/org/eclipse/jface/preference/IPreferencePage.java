...
public interface IPreferencePage extends IDialogPage {
	 ...
	 *
	 * @return <code>false</code> to abort page flipping and the have the current
	 *         page remain visible, and <code>true</code> to allow the page flip
	 */
	 ...
	 *
	 * @return <code>false</code> to abort the container's cancel procedure and
	 *         <code>true</code> to allow the cancel to happen
	 */
